...
enum {
	...
	, MAX_ANIMATION_INSTANCE_COUNT = 2048
	, MAX_ANIMATION_BONES_PER_INSTANCE = 256
	, MAX_ANIMATION_RESULT_MATRIX_COUNT = MAX_ANIMATION_INSTANCE_COUNT * MAX_ANIMATION_BONES_PER_INSTANCE
	...
	, FONT_INDEX_START = IMGUI_INDEX_START + IMGUI_INDEX_COUNT
	, FONT_INDEX_COUNT = 3



	, ALL_DESCRIPTOR_COUNT = GBUFFER_INDEX_COUNT + (GROUP_COUNT * FRAMEGROUP_COUNT) + PARTICLE_INDEX_COUNT + PARTICLE_SPAWN_INDEX_COUNT +
	ANIMATION_INDEX_COUNT + TEXTURE_MATERIALS_INDEX_COUNT + TEXTURE_CUBE_INDEX_COUNT + TEXTURE_INDEX_COUNT + IMGUI_INDEX_COUNT + FONT_INDEX_COUNT
};
