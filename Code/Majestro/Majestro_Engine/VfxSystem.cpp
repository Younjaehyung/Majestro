...
std::optional<VfxSpawnDesc> VfxSystem::ResolveVfxSpawn(SkillType skillType, uint8 reason)
{
	...
	case EffectSpawnReason::Fire:
		...
		if (skillType == SkillType::DragonSkill4)
			return VfxSpawnDesc{ L"VFX_Dragon_Skill_04", Vec3::Zero, Vec3(30.0f) };

		if (skillType == SkillType::DragonSkill3)
			return VfxSpawnDesc{ L"VFX_Dragon_Skill_03", Vec3::Zero, Vec3(30.0f) };
