...
inline BulletStat GetBulletStat(SkillType type)
{
	...
	case SkillType::GuitarAttack_1: return BulletStat{ 30.0f, 1800.0f, 5.30f, 1.4f, 20.0f, true };
	case SkillType::GuitarAttack_2: return BulletStat{ 50.0f, 1800.0f, 5.45f, 1.8f, 32.0f, false };
	case SkillType::GuitarAttack_3: return BulletStat{ 75.0f, 1800.0f, 5.45f, 1.8f, 32.0f, false };
