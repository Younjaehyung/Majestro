...
inline BulletStat GetBulletStat(SkillType type)
{
	...
	case SkillType::BaseAttack: return BulletStat{ 15.0f, 5300.0f, 0.22f, 6.0f, 0.0f, false };
	...
	//case SkillType::BaseSkill2: return BulletStat{ 0.0f, 80.0f, 0.50f, 3.0f, 40.0f, 1 };
		...
		case SkillType::GuitarAttack_1: return BulletStat{ 30.0f, 4000.0f, 50.0f, 0.5f, 20.0f, true };
		case SkillType::GuitarAttack_2: return BulletStat{ 50.0f, 4000.0f, 50.0f, 0.3f, 32.0f, false };
		case SkillType::GuitarAttack_3: return BulletStat{ 75.0f, 4000.0f, 50.0f, 0.15f, 32.0f, false };


	case SkillType::HornAttack: return BulletStat{ 20.0f, 950.0f, 0.45f, 2.8f, 0.0f, false };
	case SkillType::BrassSkill2: return BulletStat{ 75.0f, 500.0f, 0.45f, 5.0f, 0.0f, false };
	case SkillType::BrassSkill3: return BulletStat{ 25.0f, 1100.0f, 0.40f, 2.2f, 0.0f, false };
	case SkillType::BrassSkill4: return BulletStat{ 50.0f, 900.0f, 0.50f, 3.0f, 0.0f, false };
