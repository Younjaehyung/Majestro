...
inline BulletStat GetBulletStat(SkillType type)
{
	...
	//case SkillType::BaseSkill2: return BulletStat{ 0.0f, 80.0f, 0.50f, 3.0f, 40.0f, 1 };
		...
		case SkillType::GuitarAttack_1: return BulletStat{ 30.0f, 4000.0f, 50.0f, 2.0f, 20.0f, true };
		case SkillType::GuitarAttack_2: return BulletStat{ 50.0f, 4000.0f, 50.0f, 2.0f, 32.0f, false };
		case SkillType::GuitarAttack_3: return BulletStat{ 75.0f, 4000.0f, 50.0f, 2.0f, 32.0f, false };
