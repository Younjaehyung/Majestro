...
void GraphicsDescriptorHeap::CommitTable()
{
	...
	handle = CD3DX12_GPU_DESCRIPTOR_HANDLE(handle, GROUP_TABLE_COUNT *static_cast<uint32>(frameCount) * DEVICE->GetDescriptorHandleIncrementSize(D3D12_DESCRIPTOR_HEAP_TYPE_CBV_SRV_UAV));
