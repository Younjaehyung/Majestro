...
enum {
	...
	, ANIMATION_INDEX_COUNT = (static_cast<uint8>(PARTICLE_INDEX::PARTICLE_INDEX_END))	//UAV_TEXTURE + UAV_STRUCTURED(1)
	...
	, ALL_DESCRIPTOR_COUNT = GBUFFER_INDEX_COUNT + (GROUP_COUNT * FRAMEGROUP_COUNT) + PARTICLE_INDEX_COUNT + TEXTURE_CUBE_INDEX_COUNT+ TEXTURE_INDEX_COUNT
};
