...
void RenderTarget::Create(RENDER_TARGET_GROUP_TYPE groupType, vector<RenderTarget>& rtVec, shared_ptr<Texture> dsTexture)
{
	...
	gEngine->get()->CreateDescriptorHeap(&heapDesc, IID_PPV_ARGS(&_rtvHeap));
